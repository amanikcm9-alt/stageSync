...
<div class="container-fluid py-3">
    ...
    <div class="card border-0 shadow-sm mb-3">
        <div class="card-body py-2">
            <form method="GET" action="{{ route('admin.candidatures.index') }}" class="row g-2">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-3">
                            <div class="btn-group w-100">
                                ...
                                <a href="{{ route('admin.candidatures.index') }}" class="btn btn-outline-secondary btn-sm">
                        ...
                        <tr class="small">
                            ...
                            <td class="text-end">
                                <div class="btn-group btn-group-sm">
                                    ...
                                    @if($candidature->statut == 'recu' || $candidature->statut == 'en_cours')
                                        ...
                                        <form action="{{ route('admin.candidatures.refuser', $candidature) }}" 
                                              method="POST" 
                                    ...
                                    @if($candidature->isArchived())
                                        <form action="{{ route('admin.candidatures.unarchive', $candidature) }}" 
                                              method="POST" class="d-inline">
                                            @csrf
                                            <button type="submit" 
                                    ...
                                    @else
                                        <form action="{{ route('admin.candidatures.archive', $candidature) }}" 
                                              method="POST" class="d-inline">
                                            @csrf
                                            <button type="submit" 
