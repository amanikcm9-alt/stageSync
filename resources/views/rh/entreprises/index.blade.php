...
<div class="container-fluid py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="{{ route('rh.entreprises.show', $entreprise->id ?? 1) }}" class="btn btn-success btn-sm">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="small">
                                ...
                                <div class="mb-2">
                                    ...
                                    @else
                                        <a href="https://techinnovation.com" target="_blank" class="text-success">
                                            techinnovation.com
                                        </a>
                                    @endif
                                </div>
                    ...
                    <div class="card bg-light border-0">
                        <div class="card-body p-3">
                            ...
                            <div class="d-grid gap-2">
                                <a href="{{ route('rh.entreprises.edit', $entreprise->id ?? 1) }}" class="btn btn-outline-success btn-sm">
                                    <i class="fas fa-edit"></i> Modifier
                                </a>
                                <a href="{{ route('rh.offres.index') }}" class="btn btn-outline-secondary btn-sm">
