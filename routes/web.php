...
Route::middleware(['auth'])->prefix('activities')->name('activities.')->group(function () {
    ...
    Route::post('/{activity}/archiver', [ActivityController::class, 'archiverActivite'])->name('archiver');
...
Route::middleware(['auth', 'role:stagiaire'])->prefix('stagiaire')->name('stagiaire.')->group(function () {
    ...
    Route::post('/activities/propose', [StagiaireDashboardController::class, 'storeProposedActivity'])->name('activities.store');
...
Route::middleware(['auth', 'role:stagiaire'])->prefix('activities')->name('activities.')->group(function () {
    ...
    Route::post('/{activity}/change-statut', [ActivityController::class, 'changeStatut'])->name('change-statut');
});

// Routes pour les messages de discussion
Route::middleware(['auth'])->prefix('messages')->name('messages.')->group(function () {
    Route::post('/send', [MessageController::class, 'sendMessage'])->name('send');
    Route::get('/activity/{activity}', [MessageController::class, 'getMessages'])->name('activity');
    Route::post('/{discussion}/read', [MessageController::class, 'markAsRead'])->name('read');
});
...
// Route pour l'envoi de messages aux stagiaires
Route::middleware(['auth'])->post('/messages/send', [MessageController::class, 'sendMessage'])->name('messages.send');
